...
void greetings1301213072(string x, string y) {
    if(y.length() != 10) {
        ...
        if(y.substr(0,2)=="13") {
            ...
            cout<<"hello, you're not from Schol od Computing, "
            <<"are you?"<<endl;
        }
    }
}

void swap_11301213072(int a, int b, int c) {
    c = b;
    b = a;
    a = c * b++;
}

void swap_21301213072(int a, int &b, int &c) {
    c = b;
    b = a;
    a = c * b++;
}

void confused1301213072() {
    int x1 = 5;
    int x2 = 5;
    int x3 = 5;
...
void remove_inside1301213072(int x) {
 ...
 string indexing1301213072(double x, double y, double z) {
